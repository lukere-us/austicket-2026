...
export const ADMIN_PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: 'cms_pages.list', label: 'Pages — view list' },
      { key: 'cms_pages.show', label: 'Pages — view record' },
      { key: 'cms_pages.new', label: 'Pages — create' },
      { key: 'cms_pages.edit', label: 'Pages — edit' },
      { key: 'cms_pages.delete', label: 'Pages — delete' },
